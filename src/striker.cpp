...
Striker::Striker(RTDBConn DBC_in, int device_nr_in, int robot_array_index, Position* robot_positions) : Robot(DBC_in, device_nr_in, robot_array_index, robot_positions)
{

}

void Striker::do_a_shot_at_goal(RawBall* datBall, bool is_left_side)
{
